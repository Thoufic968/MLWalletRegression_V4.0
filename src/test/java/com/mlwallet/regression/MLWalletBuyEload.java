...
public class MLWalletBuyEload {
    ...
    public void buyELoadTransactionWithValidMLPin_BE_TC_78() throws Exception {
        MLWalletBusinessLogic.buyELoadTransactionWithValidMLPin_BE_TC_78(prop.getproperty("Fully_Verified"), 3);
    }

    @Test(priority = 44)
    public void buyELoadTransactionWithInValidMLPin_BE_TC_79() throws Exception {
        MLWalletBusinessLogic.buyELoadTransactionWithInValidMLPin_BE_TC_79(prop.getproperty("Fully_Verified"), 3);
    }
