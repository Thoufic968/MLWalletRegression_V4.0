...
public class MLWalletBuyEload {
    ...
    {
        MLWalletBusinessLogic.buyELoadInsufficientBalance_BE_TC_05(prop.getproperty("Fully_Verified"),3);
    }
    ...
    public void buyELoadLoadSelectionPageUIValidation_BE_TC_13() throws Exception {
        MLWalletBusinessLogic.buyELoadLoadSelectionPageUIValidation_BE_TC_13(prop.getproperty("Fully_Verified"),4);
    }

    @Test(priority = 11)
    public void buyELoadLoadSelectionChangeBtnFunctionality_BE_TC_14() throws Exception {
        MLWalletBusinessLogic.buyELoadLoadSelectionChangeBtnFunctionality_BE_TC_14(prop.getproperty("Fully_Verified"),4);
    }
    ...
    public void buyELoadPromoConfirmationPopupValidation_BE_TC_24() throws Exception {
        MLWalletBusinessLogic.buyELoadPromoConfirmationPopupValidation_BE_TC_24(prop.getproperty("Fully_Verified"),4);
    }

    @Test(priority = 22)
    public void buyELoadOTPPageUIValidation_BE_TC_25() throws Exception {
        MLWalletBusinessLogic.buyELoadOTPPageUIValidation_BE_TC_25(prop.getproperty("Fully_Verified"),4);
    }

    @Test(priority = 23)
    public void buyELoadSuccessfulTransactionUIValidation_BE_TC_26() throws Exception {
        MLWalletBusinessLogic.buyELoadSuccessfulTransactionUIValidation_BE_TC_26(prop.getproperty("Fully_Verified"),4);
    }
    ...
    public void buyELoadLocationPopUpAllowFunctionality_BE_TC_55() throws Exception {
        MLWalletBusinessLogic.buyELoadLocationPopUpAllowFunctionality_BE_TC_55(prop.getproperty("Fully_Verified"), 4);
    }
    ...
    public void buyELoadInternetInterruptionWhileEnteringOTP_BE_TC_61() throws Exception {
        MLWalletBusinessLogic.buyELoadInternetInterruptionWhileEnteringOTP_BE_TC_61(prop.getproperty("Fully_Verified"), 4);
    }
