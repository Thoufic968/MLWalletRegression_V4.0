...
//    {
//        MLWalletBusinessLogic.buyELoadTransactionDetails_BE_TC_01(prop.getproperty("Fully_Verified"),2);
//    }
//
//    @Test(priority = 2)
...
//    {
//        MLWalletBusinessLogic.buyELoadInsufficientBalance_BE_TC_05(prop.getproperty("Branch_Verified_LowBalance"),2);
//    }
//
//    @Test(priority = 6)
...
//        MLWalletBusinessLogic.buyELoadNextButtonFunctionalityOnELoadTransactionPage_BE_TC_11(prop.getproperty("Fully_Verified"),prop.getproperty("GLOBE"),2);
//    }
//
//    @Test(priority = 9)
...
//        MLWalletBusinessLogic.buyELoadLoadSelectionPageUIValidation_BE_TC_13(prop.getproperty("Fully_Verified"),2);
//    }
//
//    @Test(priority = 11)
//    public void buyELoadLoadSelectionChangeBtnFunctionality_BE_TC_14() throws Exception {
//        MLWalletBusinessLogic.buyELoadLoadSelectionChangeBtnFunctionality_BE_TC_14(prop.getproperty("Fully_Verified"),2);
//    }
//
//    @Test(priority = 12)
//    public void buyELoadTransactionDetailsPageUIValidation__BE_TC_15() throws Exception {
//        MLWalletBusinessLogic.buyELoadTransactionDetailsPageUIValidation_BE_TC_15(prop.getproperty("Fully_Verified"),2);
//    }
//
//    @Test(priority = 13)
...
//        MLWalletBusinessLogic.buyELoadPromoConfirmationPopupValidation_BE_TC_24(prop.getproperty("Fully_Verified"),2);
//    }
//
//    @Test(priority = 22)
//    public void buyELoadOTPPageUIValidation_BE_TC_25() throws Exception {
//        MLWalletBusinessLogic.buyELoadOTPPageUIValidation_BE_TC_25(prop.getproperty("Fully_Verified"),2);
//    }
//
//    @Test(priority = 23)
//    public void buyELoadSuccessfulTransactionUIValidation_BE_TC_26() throws Exception {
//        MLWalletBusinessLogic.buyELoadSuccessfulTransactionUIValidation_BE_TC_26(prop.getproperty("Fully_Verified"),2);
//    }
//
//    @Test(priority = 24)
...
//        MLWalletBusinessLogic.buyELoadLocationPopupValidation_BE_TC_51(prop.getproperty("Fully_Verified"), 2);
//    }
//
//    @Test(priority = 27)
//    public void buyELoadLocationDenyFunctionality_BE_TC_52() throws Exception {
//        MLWalletBusinessLogic.buyELoadLocationDenyFunctionality_BE_TC_52(prop.getproperty("Fully_Verified"), 2);
//    }
//
//    @Test(priority = 28)
//    public void buyELoadLocationPermissionDenyCloseBtnFunctionality_BE_TC_53() throws Exception {
//        MLWalletBusinessLogic.buyELoadLocationPermissionDenyCloseBtnFunctionality_BE_TC_53(prop.getproperty("Fully_Verified"), 2);
//    }
//
//    @Test(priority = 29)
//    public void buyELoadLocationPermissionDenyOpenSettingsBtnFunctionality_BE_TC_54() throws Exception {
//        MLWalletBusinessLogic.buyELoadLocationPermissionDenyOpenSettingsBtnFunctionality_BE_TC_54(prop.getproperty("Fully_Verified"), 2);
//    }
//
//    @Test(priority = 30)
//    public void buyELoadLocationPopUpAllowFunctionality_BE_TC_55() throws Exception {
//        MLWalletBusinessLogic.buyELoadLocationPopUpAllowFunctionality_BE_TC_55(prop.getproperty("Fully_Verified"), 2);
//    }
//
//    @Test(priority = 31)
...
//        MLWalletBusinessLogic.buyELoadInternetInterruptionWhileEnteringOTP_BE_TC_61(prop.getproperty("Fully_Verified"), 2);
//    }
//
//    @Test(priority = 37)
...
//        MLWalletBusinessLogic.buyELoadTransactionValidationAfterMinimizingApp_BE_TC_069(prop.getproperty("Fully_Verified"), 2);
//    }
//
//    @Test(priority = 43)
//    public void buyELoadTransactionWithValidMLPin_BE_TC_78() throws Exception {
//        MLWalletBusinessLogic.buyELoadTransactionWithValidMLPin_BE_TC_78(prop.getproperty("Fully_Verified"), 2);
//    }
//
//    @Test(priority = 44)
//    public void buyELoadTransactionWithInValidMLPin_BE_TC_79() throws Exception {
//        MLWalletBusinessLogic.buyELoadTransactionWithInValidMLPin_BE_TC_79(prop.getproperty("Fully_Verified"), 2);
//    }
//
//    @Test(priority = 45)
//    public void buyELoadInOTPPopupValidation_BE_TC_089() throws Exception {
//        MLWalletBusinessLogic.buyELoadInOTPPopupValidation_BE_TC_089(prop.getproperty("Fully_Verified"), 2);
//    }
//
//    @Test(priority = 46)
//    public void buyELoadTransactionInAppOTPPopupUIValidation_BE_TC_090() throws Exception {
//        MLWalletBusinessLogic.buyELoadTransactionInAppOTPPopupUIValidation_BE_TC_090(prop.getproperty("Fully_Verified"), 2);
//    }
//
//    @Test(priority = 47)
//    public void buyELoadTransactionNewOTPAfterSixtySecondsValidation_BE_TC_091() throws Exception {
//        MLWalletBusinessLogic.buyELoadTransactionNewOTPAfterSixtySecondsValidation_BE_TC_091(prop.getproperty("Fully_Verified"), 2);
//    }
//
//    @Test(priority = 48)
//    public void buyELoadTransactionOTPCancelBtnFunctionality_BE_TC_092() throws Exception {
//        MLWalletBusinessLogic.buyELoadTransactionOTPCancelBtnFunctionality_BE_TC_092(prop.getproperty("Fully_Verified"), 2);
//    }
//
//    @Test(priority = 49)
//    public void buyELoadTransactionOTPContinueBtnFunctionality_BE_TC_093() throws Exception {
//        MLWalletBusinessLogic.buyELoadTransactionOTPContinueBtnFunctionality_BE_TC_093(prop.getproperty("Fully_Verified"), 2);
//    }
//
//    @Test(priority = 50)
...
//        MLWalletBusinessLogic.buyELoadMaximumLimitForBuyerTierVerifiedTier_BE_TC_45(prop.getproperty("Fully_Verified"), 2);
//    }
//
//    @Test(priority = 56)
//    public void buyELoadMaximumTransactionForBuyerTierVerifiedTier_BE_TC_48() throws Exception {
//        MLWalletBusinessLogic.buyELoadMaximumTransactionForBuyerTierVerifiedTier_BE_TC_48(prop.getproperty("Fully_Verified"), 2);
//    }
//
//    @Test(priority = 57)
//    public void buyELoadSecondTimeLoadSelectionPopupValidation_BE_TC_29() throws Exception {
//        MLWalletBusinessLogic.buyELoadSecondTimeLoadSelectionPopupValidation_BE_TC_29(prop.getproperty("Fully_Verified"), 2);
//    }
//
//    @Test(priority = 58)
//    public void buyELoadMLPinPageNavigation_BE_TC_87() throws Exception {
//        MLWalletBusinessLogic.buyELoadMLPinPageNavigation_BE_TC_87("9999999999",2);
//    }
