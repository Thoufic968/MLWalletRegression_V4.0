...
public class MLWalletUseQR {
    ...
    public static By objInvalidQRCodeMsg = By.xpath("//*[@resource-id='something']/following-sibling::android.widget.TextView");
    ...
    public static By objAmountInputField = By.xpath("//android.widget.EditText[@content-desc='JG4BXX']");
    ...
    public static By objDenyButton = By.xpath("//*[@text='DON’T ALLOW']");
