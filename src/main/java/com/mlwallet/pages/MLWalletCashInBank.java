...
public class MLWalletCashInBank {
    ...
    public static By objCashInBackArrowBtn = By.xpath("//*[@text='Cash In']/parent::android.view.ViewGroup/preceding-sibling::android.view.ViewGroup");
    ...
    public static By objSelectBankBackBtn = By.xpath("//*[@text='Select a Bank']/parent::android.view.ViewGroup/preceding-sibling::android.view.ViewGroup");
