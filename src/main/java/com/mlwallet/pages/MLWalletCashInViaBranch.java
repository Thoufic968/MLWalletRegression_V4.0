...
public class MLWalletCashInViaBranch {
	...
	public static By objCashInConfirmationPopup = By.xpath("//*[@text='Continue']/parent::android.view.ViewGroup/parent::android.view.ViewGroup/preceding-sibling::android.widget.TextView");
